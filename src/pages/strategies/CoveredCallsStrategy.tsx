  ...
  return (
    ...
    <div className="space-y-6">
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-gray-700 dark:text-gray-300 mb-2">
                Met een covered call ga je een contract aan waarbij je <strong>bereid bent om je aandelen te verkopen</strong> tegen
                een bepaalde prijs (strike) vóór een bepaalde datum (expiratie). In ruil hiervoor ontvang je direct een <strong>premie</strong>.
              </p>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <p className="text-sm text-gray-600 dark:text-gray-400">Op Aandelen/ETFs</p>
          <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">0</p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-lg shadow-sm border border-gray-200 dark:border-gray-700 p-6">
          <p className="text-sm text-gray-600 dark:text-gray-400">Op LEAPS</p>
          <p className="text-2xl font-bold text-gray-900 dark:text-white mt-1">0</p>
        </div>
      </div>
        ...
        <div className="space-y-6">
            ...
            <div className="flex items-start gap-3">
              ...
              <div className="flex-1 space-y-6">
                ...
                <p className="text-sm text-gray-700 dark:text-gray-300 mb-3">
                  Een Covered Call is een strategie waarbij je een call optie <strong>schrijft (verkoopt)</strong> op aandelen,
                  ETFs of LEAPS die je al bezit. Je ontvangt direct een <strong>premie</strong> in ruil voor het recht dat
                  iemand anders je aandelen kan kopen tegen de strike price.
                </p>
          ...
          <div className="space-y-3">
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex-1 text-left">
                  <p className="font-medium text-gray-900 dark:text-white">LEAPS</p>
                  <p className="text-sm text-gray-600 dark:text-gray-400">

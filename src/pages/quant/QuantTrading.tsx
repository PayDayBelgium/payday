  ...
  return (
    <div className="space-y-6">
      <p className="text-sm text-ink-600 dark:text-ink-300 max-w-2xl leading-relaxed">
        Hier draait alles om data: kwantitatieve modellen, edge-detectie en systematische signalen.
        Dit is een voorproefje — de tools volgen.
      </p>
        ...
        {[
          {
            ...
            d: 'Rangschik kansen op IV rank, edge en liquiditeit.',
          },
          { icon: Activity, t: 'Edge-modellen', d: 'Kwantificeer verwachte waarde per strategie.' },
          {
            icon: TrendingUp,
            t: 'Backtesting',
            d: 'Test systematische regels op historische data.',
          },
        ].map(({ icon: Icon, t, d }) => (
      ...
      <div className="surface-card p-8 text-center">
        ...
        <h2 className="text-lg font-semibold text-ink-900 dark:text-white tracking-tight mb-2">
          De off-piste toolkit
        </h2>
        <p className="text-sm text-ink-500 dark:text-ink-400 max-w-md mx-auto leading-relaxed">
          We bouwen hier de kwantitatieve tools uit. Blijf actief in de community om als eerste
          toegang te krijgen.
        </p>
      </div>
    </div>

...
export const AdminDashboard: React.FC = () => {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="bg-white dark:bg-trading-dark-800 border border-surface-line dark:border-trading-dark-600 rounded-lg shadow-sm p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-ink-600 dark:text-ink-400 text-sm">Total Users</p>
              <p className="text-3xl font-bold text-ink-900 dark:text-white">{stats.totalUsers}</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white dark:bg-trading-dark-800 border border-surface-line dark:border-trading-dark-600 rounded-lg shadow-sm p-6">
          <div className="flex items-center gap-4">
            ...
            <div>
              <p className="text-ink-600 dark:text-ink-400 text-sm">Active This Week</p>
              <p className="text-3xl font-bold text-ink-900 dark:text-white">
      ...
      {/* Quick Actions */}
      <div className="bg-white dark:bg-trading-dark-800 border border-surface-line dark:border-trading-dark-600 rounded-lg shadow-sm p-6">
        <h2 className="text-xl font-semibold text-ink-900 dark:text-white mb-4">Quick Actions</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <button
            onClick={() => navigate('/admin/users')}
            className="flex items-center justify-between p-4 bg-surface dark:bg-trading-dark-700/50 hover:bg-surface-subtle dark:hover:bg-trading-dark-700 rounded-lg transition-colors border border-surface-line dark:border-trading-dark-500"
          >
            <div className="flex items-center gap-3">
              <Users className="w-5 h-5 text-primary-700 dark:text-primary-300" />
              <div className="text-left">
                <p className="font-medium text-ink-900 dark:text-white">Manage Users</p>

 ...
 * Emits TodoAdded.
 */
export const addTodo = (todo: Todo, timestamp: string) => (dispatch: AppDispatch) =>
  dispatch(commit([createEvent('TodoAdded', { todo }, timestamp)]));

/**
 * Edit the text of an existing todo. Emits TodoEdited.
 */
export const editTodo = (id: string, text: string, timestamp: string) => (dispatch: AppDispatch) =>
...
export const toggleTodo =
  (id: string, timestamp: string) => (dispatch: AppDispatch, getState: () => RootState) => {
 ...
 */
export const reopenTodo = (id: string, timestamp: string) => (dispatch: AppDispatch) =>
  dispatch(commit([createEvent('TodoReopened', { id }, timestamp)]));

/**
 * Delete a todo. Emits TodoDeleted.
 */
export const deleteTodo = (id: string, timestamp: string) => (dispatch: AppDispatch) =>

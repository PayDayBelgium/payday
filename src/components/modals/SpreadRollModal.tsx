...
export const SpreadRollModal: React.FC<SpreadRollModalProps> = ({
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!longClosePremium || !longNewExpiration || !longNewPremium ||
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                {longLeg.ticker} {optionType} {spreadType} Spread ${Math.min(longLeg.strike, shortLeg.strike)}/${Math.max(longLeg.strike, shortLeg.strike)}
              </p>
            </div>
          </div>

  ...
  return (
    <div className="relative w-full rounded-xl overflow-hidden border border-[var(--line)]">
      <svg
        ...
        style={{ aspectRatio: '800 / 420', fontFamily: "'Inter Tight', Inter, sans-serif" }}
      >
        <defs>
          ...
          <linearGradient id="pm-far" x1="0" y1="0" x2="0" y2="1">
            ...
            <stop offset="1" stopColor="#DDE8F6" />
          </linearGradient>
          <linearGradient id="pm-mid" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0" stopColor="#8FB1D9" />
            <stop offset="1" stopColor="#B9D0EA" />
          </linearGradient>
          <linearGradient id="pm-near" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0" stopColor="#5A8DC4" />
            <stop offset="1" stopColor="#88B0DA" />
          </linearGradient>
          <linearGradient id="pm-valley" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0" stopColor="#ECF3FC" />
            <stop offset="1" stopColor="#FCFDFF" />
          </linearGradient>
          <linearGradient id="pm-cabin" x1="0" y1="0" x2="0" y2="1">
            <stop offset="0" stopColor="#FFFFFF" />
            <stop offset="1" stopColor="#DCE7F4" />
          </linearGradient>
          <radialGradient id="pm-glow" cx="0.5" cy="0.45" r="0.55">
            <stop offset="0" stopColor="#FFD37A" stopOpacity="0.95" />
            <stop offset="1" stopColor="#FFD37A" stopOpacity="0" />
          </radialGradient>
          <radialGradient id="pm-mogul" cx="0.4" cy="0.3" r="0.78">
            <stop offset="0" stopColor="#FFFFFF" />
            <stop offset="1" stopColor="#CBDDF1" />
          </radialGradient>
        ...
        <circle cx="735" cy="58" r="34" fill="rgba(255,231,170,0.5)" />
        <circle cx="735" cy="58" r="15" fill="rgba(255,231,170,0.85)" />
        <path
          d="M0 240 L130 175 L250 215 L380 150 L520 200 L650 150 L800 188 L800 300 L0 300Z"
          fill="url(#pm-far)"
          opacity="0.65"
        />
        <path
          d="M0 285 L110 235 L230 275 L360 205 L470 255 L600 195 L720 240 L800 215 L800 320 L0 320Z"
          fill="url(#pm-mid)"
          opacity="0.85"
        />
        <path
          d="M0 332 L120 272 L250 212 L370 152 L495 92 L585 50 L660 76 L770 128 L800 148 L800 332Z"
          fill="url(#pm-near)"
        />
        <path d="M495 92 L585 50 L660 76 L636 92 L606 68 L578 90 L530 102Z" fill="#fff" />
        <path
          d="M584 60 Q512 138 432 198 Q352 256 300 318"
          fill="none"
          stroke="#fff"
          strokeWidth="16"
          strokeLinecap="round"
        ...
        <g fill="#0E4C92">
          <polygon points="22,376 14,394 30,394" />
          <polygon points="52,384 44,402 60,402" />
          <polygon points="10,390 4,404 16,404" />
        </g>
        ...
        <g transform="translate(48 360)" filter="url(#pm-soft)">
          ...
          <rect x="-15" y="7" width="11" height="12" rx="1.5" fill="#CFE0F3" />
          <rect x="4" y="7" width="11" height="12" rx="1.5" fill="#CFE0F3" />
        </g>
        {/* towers */}
        <g stroke="#33425C" strokeWidth="2.4" strokeLinecap="round">
          <line x1="190" y1="288" x2="190" y2="332" />
          <line x1="178" y1="288" x2="202" y2="288" />
          <line x1="350" y1="208" x2="350" y2="300" />
          <line x1="338" y1="208" x2="362" y2="208" />
          <line x1="490" y1="132" x2="490" y2="240" />
          <line x1="478" y1="132" x2="502" y2="132" />
        </g>
        <g transform="translate(592 60)" filter="url(#pm-soft)">
          <rect x="-16" y="-6" width="32" height="18" rx="3" fill="#FFFFFF" stroke="#D8E1EC" />
          <polygon points="-19,-6 0,-15 19,-6" fill="#2F6CAE" />
        </g>
        <path
          id="pm-cable"
          d="M 56 350 Q 230 268 350 208 Q 470 148 588 58"
          fill="none"
          stroke="#33425C"
          strokeWidth="1.4"
        />
        ...
        <g>
          <use href="#pm-gondola" />
          <animateMotion dur="22s" begin="-7.3s" repeatCount="indefinite">
            <mpath href="#pm-cable" />
          </animateMotion>
        </g>
        <g>
          <use href="#pm-gondola" />
          <animateMotion dur="22s" begin="-14.6s" repeatCount="indefinite">
            <mpath href="#pm-cable" />
          </animateMotion>
        </g>
        ...
        <g onClick={onOpenQuant} style={{ cursor: onOpenQuant ? 'pointer' : 'default' }}>
          <path
            d="M626 78 Q672 108 650 148 Q632 178 658 206 L630 206 Q606 174 624 146 Q646 108 602 82 Z"
            fill="#fff"
            opacity="0.26"
          />
          <g>
            <ellipse cx="630" cy="104" rx="13" ry="6" fill="url(#pm-mogul)" />
            <ellipse cx="652" cy="124" rx="14" ry="6.5" fill="url(#pm-mogul)" />
            <ellipse cx="632" cy="146" rx="13" ry="6" fill="url(#pm-mogul)" />
            <ellipse cx="652" cy="168" rx="14" ry="6.5" fill="url(#pm-mogul)" />
            <ellipse cx="636" cy="190" rx="13" ry="6" fill="url(#pm-mogul)" />
            <g fill="#9DB6D6" opacity="0.3">
              <ellipse cx="643" cy="115" rx="6.5" ry="2" />
              <ellipse cx="643" cy="157" rx="6.5" ry="2" />
              <ellipse cx="645" cy="179" rx="6.5" ry="2" />
            </g>
          </g>
          <path
            d="M630 92 Q662 110 634 130 Q608 150 650 174 Q672 190 638 202"
            fill="none"
            stroke="#9DB6D6"
            strokeWidth="2.4"
            strokeLinecap="round"
        ...
        <g fontSize="9.5" fontWeight="600" fill="#0F1E36">
          ...
          <g
            ...
            filter="url(#pm-soft)"
            onClick={onOpenQuant}
            style={{ cursor: onOpenQuant ? 'pointer' : 'default' }}
          >
        ...
        <g
          ...
          style={{ cursor: onOpenCommunity ? 'pointer' : 'default' }}
        >
          ...
          <rect x="-35" y="30" width="17" height="17" rx="1.5" fill="#FFD37A" />
          <rect x="18" y="30" width="17" height="17" rx="1.5" fill="#FFD37A" />
          <rect x="-7.5" y="34" width="15" height="26" rx="1.5" fill="#3A2410" />
          <rect x="33" y="-2" width="9" height="15" fill="#4A2F18" />
          <path
            d="M37.5 -4 q-6.5 -8 0 -14 q6.5 -6.5 0 -13"
            fill="none"
            stroke="#cfd8e3"
            strokeWidth="2.2"
            opacity="0.7"
          ...
          <circle cx="-35" cy="12.5" r="2.1" fill="#FFB347" />
          <circle cx="-13" cy="10" r="2.1" fill="#7AD1FF" />
          <circle cx="13" cy="10" r="2.1" fill="#FF8FA3" />
          <circle cx="35" cy="12.5" r="2.1" fill="#9DFFB0" />
          <g transform="translate(-58 38)">
            ...
            <rect
              ...
              transform="rotate(-14)"
            />
            <ellipse cx="0" cy="13" rx="10" ry="3" fill="#fff" opacity="0.8" />
          </g>
          ...
          <g fill="#5A3A1E">
            <rect x="-25" y="58" width="10" height="6" rx="1" />

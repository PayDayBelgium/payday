...
export const LoadingOverlay: React.FC<LoadingOverlayProps> = ({ message, subtitle }) => {
  return (
    <div className="fixed inset-0 bg-gradient-to-br from-primary-50 to-indigo-100 dark:from-gray-900 dark:to-gray-800 flex items-center justify-center z-[9999]">
